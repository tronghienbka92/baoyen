...
namespace Nop.Services.NhaXes
{
    public partial interface INhanVienService
    {
        ...
        List<NhanVien> GetAllNhanVien(int NhaXeId,int VanPhongId, string TenNhanVien = "", ENKieuNhanVien[] kieunhanviens = null);
        List<NhanVien> GetAllByVanPhongId(int VanPhongId,string TenNhanVien="",ENKieuNhanVien[] kieunhanviens=null);
