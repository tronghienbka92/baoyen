    ...
    public class ApiController : BaseController
    {
        ...
        public ActionResult GetSoDoGheXe(int NhaXeId, int CustomerId, int XeXuatBenId, string apiToken)
        {
            ...
            foreach (var sodo in sodoghequytacs)
            {
                ...
                var phoive = _phoiveService.GetPhoiVeApi(xexuatben, sodo);
                item.Id = phoive.Id;
                ...
                item.ViTriLen = phoive.ViTriLenXe;
                ...
                if(item.ChangId>0)
                {
                    ...
                    if(changinfo!=null)
                    {
                        ...
                        if(String.IsNullOrEmpty(item.ViTriLen))
                            item.ViTriLen = changinfo.DiemDen != null ? changinfo.DiemDon.TenDiemDon : "";
                    }
                }
                phoives.Add(item);
            }
